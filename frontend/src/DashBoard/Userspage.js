            ...
            {editingUser && (
                <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-8 rounded-lg">
                        <h2 className="text-2xl font-bold mb-4">Edit User <FontAwesomeIcon icon={faEdit}  className='text-lg '/></h2>
                        <form onSubmit={handleSubmit}>
                            <input type="text" name="name" value={editedUserData.name} onChange={handleChange} placeholder="Name" className="mb-2 p-2 border-2 rounded-md block w-full" required />
                            <input type="email" name="email" value={editedUserData.email} onChange={handleChange} placeholder="Email" className="mb-2 p-2 border-2 rounded-md block w-full" required />
                            <input type="text" name="role" value={editedUserData.role} onChange={handleChange} placeholder="Role" className="mb-2 p-2 border-2 rounded-md block w-full" required />
