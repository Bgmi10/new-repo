                ...
                <Fragment>
                    ...
                    <div className="bg19" >
                        ...
                        <ScrollAnimation animateIn="fadeInLeft" animateOnce="true">
                            <div className="box5">
                                <div className="groupi" style={{marginTop:'10%'}}>
                        ...
                        <ScrollAnimation animateIn="fadeIn" animateOnce="true">
                            <div className="why">
                                ...
                                <div className="cards vap">
                                    <div className="card">
                                        <div className="card-data" style={{paddingTop:'20px'}}>
                                            <img className="card-img" style={{margin:'auto'}} src={api} />
                                            <h2>API Sentinel</h2>
                                    ...
                                    <div className="card">
                                        <div className="card-data" style={{paddingTop:'20px'}}>
                                            <img className="card-img" style={{margin:'auto'}} src={web} />
                                            <h2>Web Fortress</h2>
                                    ...
                                    <div className="card">
                                        <div className="card-data" style={{paddingTop:'20px'}}>
                                            <img className="card-img" style={{margin:'auto'}} src={service} />
